...
program.command('node-get')
  ...
  .option('-l, --limit <number>', 'Limit the size of the resulset when applicable, default 5', "5")
  .option('-o, --offset <number>', 'Offset when applicable, default 0', "0")
  .option('-s, --sort <string>', 'Sorting direction [desc|asc], default desc', "desc")
  .option('-i, --include-unconfirmed', 'Include unconfirmed when applicable', false)
